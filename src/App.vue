<template>
  <div
    id="app"
    class="flex flex-col max-h-screen h-screen bg-gray-100 dark-mode:bg-gray-800"
  >
    <nav>
      <div class="relative bg-white dark-mode:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
          <div
            class="flex flex-col sm:flex-row sm:justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10 dark-mode:border-gray-800"
          >
            <div class="lg:w-0 lg:flex-1 mb-3 sm:mb-0">
              <p class="flex font-bold text-lg">
                <a
                  href="#"
                  class="text-gray-800 uppercase transition-all duration-100 ease-in hover:tracking-widest dark-mode:text-gray-200 cursor-pointer"
                >
                  T i m o
                </a>
              </p>
            ...
            <div class="flex items-center justify-end space-x-8 flex-1 lg:w-0">
              ...
              >
                <svg
                  ...
                  class="svg-inline--fa fa-w-16 mr-1 fill-current inline-block"
                >
                  <path
    ...
    <main class="flex flex-grow lg:justify-around flex-col lg:flex-row">
      <Mail
        class="mt-16 mb-0 lg:max-w-screen-md lg:order-2 mx-auto lg:mx-0 flex-grow"
      />
      <p class="hidden lg:block mt-auto mb-4 w-56 text-center lg:order-1">
        <a
          class="text-gray-500 transition duration-100 hover:text-gray-700 hover:underline dark-mode:hover:text-gray-300"
      ...
      <p class="hidden lg:block mt-auto mb-4 w-56 text-center lg:order-3">
        <a
          class="text-gray-500 transition duration-100 hover:text-gray-700 hover:underline dark-mode:hover:text-gray-300"
